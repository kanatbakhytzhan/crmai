...
-- SELECT column_name FROM information_schema.columns WHERE table_name = 'leads' AND column_name IN ('category','lead_score','last_inbound_at','last_outbound_at','handoff_mode','extracted_fields');
